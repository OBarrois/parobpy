...
#-- Setting up all different S cases (10 different cases at once)
...
S_Ek =      [3e-7,              1e-7,              2e-7,                       6.3e-9,                     5e-8,                           2e-8,                           1e-8,               6.3e-9,                     6.3e-9,             3e-10,            2e-7]#]
S_run_Ek =  ['3e7',             '1e7',             '1e7',                      '1e7',                      '1e7',                          '1e7',                          '1e8',              '1e8',                      '6e9',              '3e10',           '1e7']#]
S_extra =   ['',                '',                ExtraDir+'Lund8o0e2',       ExtraDir+'PathLund3o2e3',   ExtraDir+'Lund3o2e3',           ExtraDir+'Lund1o6e4',           '',                 ExtraDir+'PathLund3o2e3',   '',                 '',               'Images/Pm-Modified_fortran-zAvg_-phi-Avg/Pm0o288']#]
S_run_Pm =  ['Pm0o25',          'Pm1o44e-1',       'Lund8e2'                   'PathLund3o2e3',            'Lund3o2e3',                    'Lund1o6e4',                    'Pm0o46e-1',        'PathLund3o2e3',            'Pm0o36e-1',        '',               'Pm2o88e-1']#]
...
S_tagRead = ['_-phi-Avg_n500',  '_-phi-Avg_n500',  '_-phi-Avg_n500_lowLund',   '_-phi-Avg_n500_pathLund',  '_-phi-Avg_n500_lowLund3o2e3',  '_-phi-Avg_n500_lowLund1o6e4',  '_-phi-Avg_n500',   '_-phi-Avg_n500_highLund',  '_-phi-Avg_n500',   '_-phi-Avg_n600', '_-phi-Avg_n500_higherPm']#]
...
for i in range(len(S_tagRead)):
    SsaveDir = '/Users/obarrois/Desktop/Parodys/Outputs/Waves'+S_run_Ek[i]+'/Balances/'+S_extra[i]+'/Data/'#Old_Computations/ # path to save colmunar balance files
...
if ( l_check_all ):
    stim = 300 #-- to get the same dimensionalised time!
    tdim_plot = td1[stim]
    plt.figure()
    plt.plot()
    stim = 312
...
#-- witdh (NOTE: Graphically Observed WITH SAME TDIM + ALIGNED!!)
...
#
l111 = 1596; lh111 = 2.22e-3; em111 = 2e-7/0.144;     w111 = 1.274104 - 0.790351;     m111 =  8.489377         #m111 = VpcolEx[306].max() #-- S=1.6e3 (Ek=2.e-7, 1.e-7 grid)
l112 = 1596; lh112 = 5.54e-4; em112 = 5e-8/0.144;     w112 = 1.229892 - 0.836394;     m112 = 11.472847         #m112 = VpcolEx[296].max() #-- S=1.6e3 (Ek=5.e-8, 1.e-7 grid)
l113 = 1596; lh113 = 2.22e-4; em113 = 2e-8/0.144;     w113 = 1.202922 - 0.834559;     m113 = 12.710137         #m113 = VpcolEx[300].max() #-- S=1.6e3 (Ek=2.e-8, 1.e-7 grid)
l114 = 2257; lh114 = 7.84e-4; em114 = 5e-8/0.144;     w114 = 1.225784 - 0.827716;     m114 = 16.256321         #m114 = VpcolEx[157].max() #-- S=2.3e3 (Ek=5.e-8, 1.e-7 grid)
l100 =  505; lh100 = 3.50e-3; em100 = 1e-7/0.0144;    w100 = 1.312785 - 0.751625;     m100 = 17.760969         #m100 = VpcolEx[207].max() #-- S=5.0e2 (Ek=1.e-7, 1.e-7 grid)
l110 = 1129; lh110 = 1.57e-3; em110 = 2e-7/0.144;     w110 = 1.273338 - 0.804302;     m110 = 6.2060032         #m110 = VpcolEx[144].max() #-- S=1.1e3 (Ek=2.e-7, 1.e-7 grid)
l120 = 1129; lh120 = 1.57e-3; em120 = 1e-7/0.072;     w120 = 1.272958 - 0.801678;     m120 = 12.295158         #m120 = VpcolEx[221].max() #-- S=1.1e3 (Ek=1.e-7, 1.e-7 grid)
l130 = 1009; lh130 = 1.40e-3; em130 = 1e-7/0.072;     w130 = 1.256672 - 0.792556;     m130 = 9.5671835         #m130 = VpcolEx[270].max() #-- S=1.0e3 (Ek=1.e-7, 1.e-7 grid)
l121 = 1590; lh121 = 1.11e-3; em121 = 7e-8/0.1;       w121 = 1.234046 - 0.807999;     m121 = 14.226600         #m121 = VpcolEx[283].max() #-- S=1.6e3 (Ek=7.e-8, 1.e-7 grid)
l122 = 1596; lh122 = 1.11e-3; em122 = 2e-7/0.288;     w122 = 1.232064 - 0.810267;     m122 = 5.0382891         #m122 = VpcolEx[295].max() #-- S=1.6e3 (Ek=2.e-7, 1.e-7 grid)
l21 = 3192;  lh21 = 1.11e-3;  em21 = 5e-8/0.144;      w21 = 1.221470 - 0.819780;      m21 = Vpcol21[298].max() #-- S=3.2e3 (Ek=5.e-8, 1.e-7 grid)
l24 = 7980;  lh24 = 1.11e-3;  em24 = 2e-8/0.144;      w24 = 1.219919 - 0.836011;      m24 = Vpcol24[298].max() #-- S=8.0e3 (Ek=2.e-8, 1.e-7 grid)

#- All Data.
ekm = [em0, em10, em110, em120, em111, em1, em121, em122, em112, em113, em114, em130, em2, em21, em211, em212, em23, em3, em24,  em100]#
wid = [w0,  w10,  w110,  w120,  w111,  w1,  w121,  w122,  w112,  w113,  w114,  w130,  w2,  w21,  w211,  w212,  w23, w3,  w24,  w100]#
lun = [l0,  l10,  l110,  l120,  l111,  l1,  l121,  l122,  l112,  l113,  l114,  l130,  l2,  l21,  l211,  l212,  l23, l3,  l24,  l100]#
leh = [lh0, lh10, lh110, lh120, lh111, lh1, lh121, lh122, lh112, lh113, lh114, lh130, lh2, lh21, lh211, lh212, lh23, lh3, lh24,  lh100]#
mid = [m0,  m10,  m110,  m120,  m111,  m1,  m121,  m122,  m112,  m113,  m114,  m130,  m2,  m21,  m211,  m212,  m23,  m3,  m24,  m100]#

#------------------------------------------------------------------------------
#%% Plot TW Width change with Lundquist and EkM for paper
...
plt.tight_layout()
if ( l_save ):
  plt.savefig(savePlot+'Scaling_TO_Width-vs-EkMag_Path-Allp-Aligned.pdf')
else:
  plt.show()
